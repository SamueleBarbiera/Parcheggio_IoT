                        ...
                        <div className="flex items-center justify-center sm:p-12 md:w-full">
                            <div className="w-full">
                                <div className="flex justify-center">
                                    <AiTwotoneCar className="h-24 w-24 flex-shrink-0 rounded-md bg-gray-50 p-2 text-indigo-900" aria-hidden="true" />
                                </div>
                                <h1 className="mb-12 mt-4 text-center text-2xl font-bold text-gray-700">Accedi con il tuo account</h1>
