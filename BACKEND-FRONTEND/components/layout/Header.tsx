                                                    ...
                                                    <Popover className="relative">
                                                        {({ open }: any) => (
                                                            <>
                                                                <Popover.Button
                                                                    className={classNames(
                                                                        open ? 'text-indigo-900' : 'text-indigo-500',
                                                                        'group inline-flex items-center rounded-md text-base font-medium hover:text-indigo-900 '
                                                                    )}
                                                                >
                                                                    <a href="#" className="group -m-2 flex items-center p-2">
                                                                        <MdOutlineShoppingBag className="h-6 w-6 flex-shrink-0 text-indigo-900" aria-hidden="true" />
                                                                        <span className="ml-2 text-sm font-medium text-indigo-900">{cartCount}</span>
                                                                    </a>
                                                                </Popover.Button>
