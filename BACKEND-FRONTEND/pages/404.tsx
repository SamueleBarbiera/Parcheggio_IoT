                        ...
                        <div className="flex flex-grow flex-col items-center justify-center  p-4">
                            <div className="mx-auto flex  max-w-7xl flex-grow flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
                                <div className="my-8 flex-shrink-0 flex-col justify-center">
                                    <p className="text-7xl font-semibold uppercase tracking-wide text-indigo-600">
                                        404 error
                                    </p>
                                    ...
                                    <div className="mt-8">
                                        <a
                                            href="#"
                                            className="rounded-lg bg-indigo-200 p-2 text-2xl font-medium text-indigo-600 shadow-xl hover:text-indigo-500"
                                        >
